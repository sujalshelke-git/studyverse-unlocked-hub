      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-muted-foreground text-sm max-w-md">
              A collaborative platform for students to connect, share knowledge,
              and improve their academic performance through interactive features.
            </p>
          </div>
        ...
        <div className="border-t mt-8 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">
            &copy; {year} StudySphere. All rights reserved.
          </p>
